      ...
      <section>
        {publications.map((pub) => (
          <ShowPublication
            ...
            buttonShow={
              ShowPublicationButton.ViewActivity | ShowPublicationButton.Manage
            }
          />
        ))}
      </section>
      ...
      <div>
        {publications.map((pub) => (
          <ShowPublication
            ...
            pub={pub}
            user={me}
            onViewPublication={(actiId) =>
              navigate(`${Route.activity}/${actiId}`)
            }
            onManage={(pubId) =>
              navigate(`${Route.managePublications}/${pubId}`)
            }
...
function ManagePublication() {
  ...
  return (
    <>
      ...
      <button onClick={() => navigate(`${Route.manageMyPublications}`)}>
