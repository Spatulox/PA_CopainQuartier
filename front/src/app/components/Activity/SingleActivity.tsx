  ...
  return (
    <div key={activity._id}>
      <div className="activity-card">
        ...
        {activity.image_link && (
          <img src={`${baseUrl}/${activity.image_link}`} alt="" />
        )}
        ...
        {!isNaN(activity.max_place - activity.reserved_place) && (
          <p>
            ...
            {activity.max_place - activity.reserved_place}
          </p>
        )}
        ...
        <div>
          ...
          <div className="activity-buttons">
            {(buttonShow & ShowActivityButton.Activity) !== 0 &&
              activity._id && (
                <button
                  onClick={() => navigate(`${Route.activity}/${activity._id}`)}
                >
                  Voir l'activité
                </button>
              )}
            ...
            {(buttonShow & ShowActivityButton.Chat) !== 0 && activity._id && (
              <button
                onClick={() =>
                  navigate(`${Route.chat}/${activity.channel_chat._id}`)
                }
              >
            ...
            {(buttonShow & ShowActivityButton.Join) !== 0 &&
              activity._id &&
              onJoin && (
                <div>
            ...
            {(buttonShow & ShowActivityButton.Leave) !== 0 &&
              activity._id &&
              onLeave && (
            ...
            {(buttonShow & ShowActivityButton.ViewPublication) !== 0 &&
              ...
              activity.publication?._id && (
                <button
                  onClick={() => onViewPublication(activity.publication._id)}
                >
